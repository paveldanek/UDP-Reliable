...
/**
 * The Client's FSM state in which it reads, creates and sends out the Packet1
 * of the two alternating packets (Packet0/Packet1).
 * 
 * @author starnet © 2021
 *
 */
public class Packet1 extends ClientState implements Notifiable {
	private static Packet1 instance;
	...
	public static Packet1 instance() {
		if (instance == null) {
			instance = new Packet1();
		}
		return instance;
	}
	...
	public void handleEvent(NewDataRead event) {
		...
		timer = new Timer(this, 1, Context.instance().getTimeoutValue());
